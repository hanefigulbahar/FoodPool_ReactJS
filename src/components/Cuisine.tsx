    ...
    return (
        <>
            {cousineData?.map(data =>
                <button onClick={e => clickCousineData(data)} key={data.id} className='border border-gray-200 bg-gray-100/30 hover:border-green-400 hover:bg-green-100/30 rounded-lg  '>
